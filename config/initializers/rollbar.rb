Rollbar.configure do |config|
  ...
  config.person_method = "current_authenticated"
  # config.person_id_method = "my_id"
  # config.person_username_method = "current_api_user.name"
  # config.person_email_method = "my_email"

  # If you want to attach custom data to all exception and message reports,
  # provide a lambda like the following. It should return a hash.
  # config.custom_data_method = lambda { { :current_user => (current_user.uuid rescue nil), 
  #                                        :current_vendor => (current_vendor.uuid rescue nil),
  #                                        :current_manager => (current_manager.uuid rescue nil) } }
